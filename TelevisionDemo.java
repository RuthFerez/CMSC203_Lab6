...
public class TelevisionDemo
	...
	public static void main(String[] args)
	{
		...
		// Declare and instantiate a TV object
		Television portable = new Television("Sharp", 19);

		// Switch power on the portable Television
		portable.power();

		// Inform the user that the Television has been powered on
		System.out.println("A " + portable.getScreenSize() + "-inch " +
		        portable.getManufacturer() + " has been turned on.");

		// Ask the user for their channel preference then set the channel
		System.out.print("What channel do you want? ");
		...
		// Show the current state of the Television
